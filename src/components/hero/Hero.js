  ...
  return (
    <div className="container hero-container">
      ...
      <p className="form-p-text">
        ...
        remember all the details when you want to share them. Bring back that
        ...
        Remember the beauty of our planet and share your stories so that
        everyone can appreciate what the world has to offer.
      </p>
    </div>
  );
}
